...
*   **Assertion & Test Sandbox Integrity**:
    ...
    *   No adding of failing WPT sandbox tests to the `exclude` or `knownFailures` lists in `tests/wpt-sandbox-config.json` unless it represents a spec deviation documented in `API_BOUNDARIES.md`.
*   **Oracle Isolation**:
