...
* **W3C Standards Conformance**: **87.3%** (18,845 / 21,586 passed assertions across 1,768 test files).
...
| :--- | :---: | :---: | :---: | :---: |
| **`Typed OM`** | 12,164 | 11,489 | **94.5%** | 🟢 **+0.9%** (ahead of Chrome) |
...
| **`Selectors`** | 5,329 | 4,006 | **75.2%** | -10.8% |
| **`Media Queries`** | 417 | 412 | **98.8%** | 🟢 **+0.2%** (ahead of Chrome) |
| **OVERALL** | **21,586** | **18,845** | **87.3%** | **-5.8%** |
