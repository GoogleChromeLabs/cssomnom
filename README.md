...
* **W3C Standards Conformance**: **86.8%** (18,855 / 21,727 passed assertions across 1,761 test files).
* **Chrome 154 Parity**: **86.8%** pass rate across 28,773 common subtests evaluated against official [`wpt.fyi`](https://wpt.fyi) runs.

| Specification Suite | In-Scope Tests | **cssomnom** | Pass Rate | Parity vs Chrome 154 |
| :--- | :---: | :---: | :---: | :---: |
| **`Typed OM`** | 12,172 | 11,500 | **94.5%** | 🟢 **+1.0%** (ahead of Chrome) |
| **`CSSOM`** | 2,143 | 1,613 | **75.3%** | -21.9% |
| **`Nesting`** | 117 | 117 | **100.0%** | 🟢 **+0.7%** (ahead of Chrome) |
| **`Syntax`** | 407 | 406 | **99.8%** | 🟢 **+1.4%** (ahead of Chrome) |
| **`Cascade`** | 499 | 246 | **49.3%** | -50.6% |
| **`Variables`** | 499 | 411 | **82.4%** | -8.2% |
| **`Selectors`** | 5,473 | 4,150 | **75.8%** | -10.2% |
