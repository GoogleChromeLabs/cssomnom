...
* **W3C Standards Conformance**: **89.8%** (20,202 / 22,494 passed assertions across 1,769 test files).
* **Chrome 154 Parity**: **89.8%** pass rate across 28,773 common subtests evaluated against official [`wpt.fyi`](https://wpt.fyi) runs.
...
| **OVERALL** | **22,494** | **20,202** | **89.8%** | **-3.3%** |
