...
* **W3C Standards Conformance**: **87.8%** (18,822 / 21,437 passed assertions across 1,768 test files).
* **Chrome 154 Parity**: **87.8%** pass rate across 28,773 common subtests evaluated against official [`wpt.fyi`](https://wpt.fyi) runs.
...
| **`Selectors`** | 5,118 | 3,921 | **76.6%** | -9.4% |
| **`Media Queries`** | 417 | 412 | **98.8%** | 🟢 **+0.2%** (ahead of Chrome) |
| **OVERALL** | **21,437** | **18,822** | **87.8%** | **-5.3%** |
