...
* **W3C Standards Conformance**: **92.2%** (20,729 / 22,487 passed assertions across 1,769 test files).
* **Chrome 154 Parity**: **92.2%** pass rate across 28,773 common subtests evaluated against official [`wpt.fyi`](https://wpt.fyi) runs.
...
| **`Selectors`** | 5,654 | 4,814 | **85.1%** | -0.8% |
| **`Media Queries`** | 417 | 412 | **98.8%** | 🟢 **+0.2%** (ahead of Chrome) |
| **OVERALL** | **22,487** | **20,729** | **92.2%** | **-0.9%** |
